...
compiled and executed correctly. This step helps in maintaining consistency between the working project and the changes you've pulled.
...
are ready to be pushed into the program. Pushing the commit then updates the remote repository with the new changes. 
