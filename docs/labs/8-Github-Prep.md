...
Be sure that you have saved this token, as once you leave the generation page, ***the token
will no longer be visible.***
You can, however, still create a new one in the event that you do lose your initial token.
