...
> When referenecing image paths, you can copy them from you Resources folder.
> With the image selected pres Alt and Enter and selcted the path manually.
> As with simple Copy and Paste you wont get the full path.
