...
- Compatible as a clear background, so if you can blend with your design use a png. 

2. Joint Photographic Experts Group (.jpg)
- Usually the best quality image, so use it if you do not need to blend images.

3. Graphics Interchange Format (.gif)
- A nice to use as an easy animation. Insert a gif and the image will be animated.
